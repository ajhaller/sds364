...
#corr.test(select(tele, gatekeeping_1:gatekeeping_16))$r
```
...
```{r}
tele$self_object <- rowMeans(select(tele, self.object_1, self.object_2, self.object_3, self.object_4, self.object_5, self.object_6, self.object_7, self.object_8, self.object_9, self.object_10))
tele$other_object <- rowMeans(select(tele, other.object_1, other.object_2, other.object_3, other.object_4, other.object_5, other.object_6, other.object_7, other.object_8, other.object_9, other.object_10))
tele <- tele %>%
