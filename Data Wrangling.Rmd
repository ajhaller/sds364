...
```{r}
alpha(select(tele, gatekeeping_2, gatekeeping_3, gatekeeping_5, 
                 gatekeeping_7, gatekeeping_9, gatekeeping_11, 
                 gatekeeping_13, gatekeeping_16))

alpha_child <- alpha(select(tele, gatekeeping_1, gatekeeping_4, gatekeeping_6, 
                 gatekeeping_8, gatekeeping_10, gatekeeping_12, 
                 gatekeeping_14, gatekeeping_15))$total[1]
```
