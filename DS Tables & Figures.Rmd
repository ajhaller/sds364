...
pairwise_Nicer <- pairwise_Nice %>%
  rename(Relationship_Satisfaction_Actor_with_Mediation_of_Self_Objectification = Relationship_Satisfaction_Actor)

apim_stp3 <- gls(Relationship_Satisfaction_Actor_with_Mediation_of_Self_Objectification ~ Gender +
                   Other_Objectification_Actor:Gender + 
